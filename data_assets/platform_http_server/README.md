...
Then, you use `inctl asset install` to publish this bundle to the catalog.
...
Use `inctl asset install` with the local bundle file to install the data asset into your running solution. This makes the files available on the local filesystem where the Generic HMI Service can access them.
...
For example, `inctl asset install bazel-bin/data_assets/platform_http_server/frontend_2/hello_world_data_2.bundle.tar --solution 1a23456b-78c9-0123-4de5-6f7g89h01i23_BRANCH`
