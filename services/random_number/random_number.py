...
class RandomNumberServicer(random_num_grpc.RandomNumberServiceServicer, state_grpc.ServiceStateServicer):
    ...
    def GetRandomNumber(
        ...
        logging.info(f'result: {result}; from range: ({request.range_start}, {request.range_end})')
