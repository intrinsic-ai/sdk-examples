...
```bash
. ./tests/run_ci.sh \
--skill=skills/points_crud:points_crud_skill,skills/start_stopwatch:start_stopwatch_skill,skills/stop_stopwatch:stop_stopwatch_py_skill \
--org=intrinsic@giza-workcells \
--solution=example_APPLIC \
--service=services/point_storage:point_storage_service,services/stopwatch:stopwatch_service
```
